...
namespace DoAn.Areas.Admin.Controllers
{
    public class TinTucsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "matintuc,tieude,hinhanh,ngaytao,trangthai,makhachhang,noidung")] TinTuc tinTuc)
        {
            try
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "matintuc,tieude,hinhanh,ngaytao,trangthai,makhachhang,noidung")] TinTuc tinTuc)
        {
            try
            {
                if (ModelState.IsValid)
